...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBar_16.setProperty("value", 18)
        ...
        self.progressBar_17.setProperty("value", kv)
        ...
        self.progressBar_19.setProperty("value", js)
        ...
        self.progressBar_20.setProperty("value", djg)
        ...
        self.progressBar_24.setProperty("value", lg)
        ...
        self.progressBar_25.setProperty("value", 10)
        ...
        self.progressBar_26.setProperty("value", 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "After Effect % 진행 중!!"))
        self.pushButton_4.setText(_translate("MainWindow", "Push"))
        self.label_5.setText(_translate("MainWindow", "Houdini % 진행 중!!"))
        self.pushButton_5.setText(_translate("MainWindow", "Push"))
        self.label_6.setText(_translate("MainWindow", "maya남국 % 진행 중!!"))
        self.pushButton_6.setText(_translate("MainWindow", "Push"))
        self.label_7.setText(_translate("MainWindow", "rigging101 % 진행 중!!"))
        ...
        self.label_15.setText(_translate("MainWindow", "djangogirls"+str(djg)+"% 진행 중!!"))
        self.pushButton_12.setText(_translate("MainWindow", "Push"))
        self.label_16.setText(_translate("MainWindow", "python hard way %진행 중!!"))
        self.label_17.setText(_translate("MainWindow", "kaist 자료구조 % 진행 중!!"))
        self.label_18.setText(_translate("MainWindow", "아놀드렌더러 % 진행 중!!"))
        self.pushButton_13.setText(_translate("MainWindow", "Push"))
        self.pushButton_14.setText(_translate("MainWindow", "Push"))
        self.label_19.setText(_translate("MainWindow", "javasript JS % 진행 중!!"))
        ...
        self.label_22.setText(_translate("MainWindow", "kaist 영상최적화기 "+str(kv)+"%진행 중!!"))
        self.pushButton_21.setText(_translate("MainWindow", "Push"))
        self.label_23.setText(_translate("MainWindow", "*- project44 Main Label -*"))
        self.label_24.setText(_translate("MainWindow", "보컬% (boolean타입+1)"))
        self.pushButton_22.setText(_translate("MainWindow", "Push"))
        self.label_25.setText(_translate("MainWindow", "중국어 % 진행 중!!"))
        self.pushButton_23.setText(_translate("MainWindow", "Push"))
        self.label_26.setText(_translate("MainWindow", "project grilgirl % 진행 중!!(인풋타입)"))
        self.label_27.setText(_translate("MainWindow", "쏙청/쏙캔/쏙킹 boolean타입+1 진행 중!!"))
        self.pushButton_24.setText(_translate("MainWindow", "Push"))
        self.label_28.setText(_translate("MainWindow", "이태리어 % 진행 중!!"))
        self.label_29.setText(_translate("MainWindow", "논리학"+str(lg)+"% 진행 중!!"))
        self.pushButton_25.setText(_translate("MainWindow", "Push"))
        self.label_30.setText(_translate("MainWindow", "social+, male+ % 진행 중!!"))
        ...
        self.label_31.setText(_translate("MainWindow", "읽기: 신문 등 boolean타입(+1씩)"))
        self.pushButton_29.setText(_translate("MainWindow", "Push"))
        self.label_32.setText(_translate("MainWindow", "프랑스어 % 진행 중!!"))
        self.pushButton_30.setText(_translate("MainWindow", "Push"))
        self.label_33.setText(_translate("MainWindow", "소요리 % 진행 중!!"))
        self.label_34.setText(_translate("MainWindow", "%며칠 지났어(시간)1"))
        self.label_35.setText(_translate("MainWindow", "%어서 시작해줘2"))
        self.label_36.setText(_translate("MainWindow", "%어서 시작해줘3"))
        self.label_37.setText(_translate("MainWindow", "%어서 시작해줘4"))
        self.label_38.setText(_translate("MainWindow", "%며칠 지났어(시간)5"))
        self.label_39.setText(_translate("MainWindow", "%어서 시작해줘6"))
        self.label_40.setText(_translate("MainWindow", "%며칠 지났어(시간)7"))
        self.label_41.setText(_translate("MainWindow", "%기대해8"))
        self.label_42.setText(_translate("MainWindow", "%더 재미있는9"))
        self.label_43.setText(_translate("MainWindow", "마지막관심부터 시간"))
        self.label_44.setText(_translate("MainWindow", "%며칠 지났어(시간)11"))
        self.label_45.setText(_translate("MainWindow", "%어서 시작해줘12"))
        self.label_46.setText(_translate("MainWindow", "%어서 시작해줘13"))
        self.label_47.setText(_translate("MainWindow", "%어서 시작해줘14"))
        self.label_48.setText(_translate("MainWindow", "영상 최적화기법 수료"))
        self.label_49.setText(_translate("MainWindow", "%며칠 지났어(시간)16"))
        self.label_50.setText(_translate("MainWindow", "%어서 시작해줘17"))
        self.label_51.setText(_translate("MainWindow", "%어서 시작해줘18"))
        self.label_52.setText(_translate("MainWindow", "%어서 시작해줘19"))
        self.label_53.setText(_translate("MainWindow", "%며칠 지났어(시간)20"))
        self.label_54.setText(_translate("MainWindow", "%며칠 지났어(시간)21"))
        self.label_55.setText(_translate("MainWindow", "%do the coat! 22"))
        self.label_56.setText(_translate("MainWindow", "%며칠 지났어(시간)23"))
        self.label_57.setText(_translate("MainWindow", "%어서 시작해줘24"))
        self.label_58.setText(_translate("MainWindow", "%하든 안하든 시간은 간다25"))
        self.label_59.setText(_translate("MainWindow", "%며칠 지났어(시간)26"))
        self.label_60.setText(_translate("MainWindow", "%어서 시작해줘27"))
        self.label_61.setText(_translate("MainWindow", "%어서 시작해줘28"))
        self.label_62.setText(_translate("MainWindow", "%며칠 지났어(시간)29"))
        self.label_63.setText(_translate("MainWindow", "%자기관리의 시작30"))
